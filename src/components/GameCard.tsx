...
export const GameCard = ({ name, imageUrl, gameUrl }: GameCardProps) => {
  ...
  return (
    <Card 
      onClick={handleClick}
      className="group relative overflow-hidden bg-gradient-card border-border hover:border-casino-gold cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-glow hover:animate-glow"
    >
