  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-full z-[-10]">
        ...
        <div className="w-full h-full bg-gradient-to-br from-emerald-950 via-slate-900 to-yellow-900">
          
          {/* Animated geometric patterns */}
          <div className="absolute inset-0 opacity-30">
            {/* Large golden orbs */}
            <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-yellow-500/15 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute bottom-1/3 right-1/4 w-40 h-40 bg-emerald-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
            ...
            <div className="absolute bottom-1/4 left-1/3 w-36 h-36 bg-green-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4.5s' }}></div>
            ...
            <div className="absolute bottom-1/2 right-1/2 w-32 h-32 bg-emerald-400/20 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '6s' }}></div>
          </div>
          ...
          <div className="absolute inset-0 opacity-10">
            ...
            <div className="absolute top-0 right-1/3 w-1 h-full bg-gradient-to-b from-emerald-300/20 to-transparent transform -rotate-12"></div>
          </div>
        </div>
      </div>
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-32 text-emerald-400/50 text-2xl md:text-3xl animate-float" style={{ animationDelay: '6s' }}>
          ♣
        </div>
        ...
        <div className="absolute bottom-1/3 left-1/2 text-green-400/40 text-2xl md:text-3xl animate-float" style={{ animationDelay: '5s' }}>
          🃏
        </div>
        ...
        <div className="absolute bottom-1/4 left-1/4 text-emerald-300/30 text-lg md:text-xl animate-float" style={{ animationDelay: '8s' }}>
          💎
        </div>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-emerald-500/20 to-transparent animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
    </>
  );
};
